...
HistoryRevampSchema.methods.toJSONFor = function () {
    return {
        case: this.case,
        status : this.status,
        stage : this.stage,
...
HistoryRevampSchema.methods.JSONCaseTransfer = function () {
    return {
        status : this.status,
        stage : this.stage,
        final_result : this.final_result
...
module.exports = mongoose.model('HistoryRevamp', HistoryRevampSchema)
