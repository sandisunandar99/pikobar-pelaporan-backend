...
const CloseContactReportSchema = new mongoose.Schema({
    ...
    emergency_contact_name: TYPE.STRING.REQUIRED,
    emergency_contact_phone: TYPE.STRING.REQUIRED,
    ...
    contact_place: TYPE.STRING.DEFAULT,
    contact_date: TYPE.DATE.DEFAULT,
    contact_durations: TYPE.NUMBER.DEFAULT,
    home_contact_date: TYPE.DATE.DEFAULT,
    home_contact_days: TYPE.NUMBER.DEFAULT,
    home_activities: TYPE.ARRAY,
    officer_is_contact: TYPE.BOOLEAN.DEFAULT,
