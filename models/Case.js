...
CaseSchema.methods.toJSONFor = function () {
  return {
    ...
    stage: this.stage, status: this.status, verified_status: this.verified_status,
    verified_comment: this.verified_comment, transfer_status: this.transfer_status || null,
    final_result: this.final_result, delete_status: this.delete_status, deletedAt: this.deletedAt,
    author: this.author.JSONCase(), last_history: this.last_history, is_test_masif: this.is_test_masif,
    is_west_java: this.is_west_java, is_reported: this.is_reported, createdAt: this.createdAt,
