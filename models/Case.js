...
CaseSchema.methods.JSONExcellOutput = function () {
    ...
    return {
       ...
       "Sumber Lapor": (this.last_history !== null && this.last_history.report_source !== null && typeof this.last_history.report_source !== 'undefined' ? this.last_history.report_source : ''),
       "NIK": this.nik,
       "Nama": this.name,
