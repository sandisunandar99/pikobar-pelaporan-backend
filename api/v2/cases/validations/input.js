...
const CaseSheetRequest = Joi.object().options({ abortEarly: false }).keys({
  interviewers_name: Joi.string().allow('', null),
  interviewers_phone_number: Joi.string().allow('', null),
  interview_date: Joi.date().allow('', null).error(() => `"${lang.interview_date}" ${lang.messages.invalid_date_format}`),
  ...
  place_of_birth: Joi.string().allow('', null),
  birth_date: Joi.date().allow('', null).error(() => `"${lang.birth_date}" ${lang.messages.invalid_date_format}`),
  age: Joi.number().required(),
  ...
  first_symptom_date: Joi.date().allow('', null).error(() => `"${label.birth_date}" ${lang.messages.invalid_date_format}`),
  diagnosis: Joi.array(),
  ...
  last_date_status_patient: Joi.date().allow('', null).error(() => `"${label.birth_date}" ${lang.messages.invalid_date_format}`),
}).unknown()
