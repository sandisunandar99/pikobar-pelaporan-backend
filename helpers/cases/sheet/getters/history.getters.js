...
module.exports = {
  getCurrentLocationType, getCurrentHospitalId, getIsPatientAddressSame, getCurrentLocationDistrictCode,
  getCurrentLocationSubdistrictCode, getCurrentLocationVillageCode, getCurrentLocationAddress,
  getIsHavingSymptoms, getFirstSymptomDate, getSymptoms, getSymptomsOther, getDiseases,
  getDiseasesOther, getDiagnosisArds, getDiagnosisPneumonia, getOtherDiagnosis, isOtherDiagnosisRespiratoryDisease,
  getOtherDiagnosisRespiratoryDisease, getPhysicalCheckTemperature, getPhysicalCheckBloodPressure,
  getPhysicalCheckPulse, getPhysicalCheckRespiration, getPhysicalCheckHeight, getPhysicalCheckWeight,
  getPhysicalActivity, isSmoking, isConsumeAlcohol, getStatus, getFinalResult, getLastDateStatusPatient,
  isRowFilled,
}
